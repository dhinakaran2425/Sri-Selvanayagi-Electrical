...
export default function Shipping() {
    ...
    // Set Hungary as the default country
    const [country, setCountry] = useState('Hungary');
    const [state, setState] = useState(shippingInfo.state);
    // Remove the countryList and select element
...
<video
            ...
            >
              <source
                src="https://res.cloudinary.com/duhcntqom/video/upload/v1709785956/r9eqdl0gzfmfu065folk.mp4"
                type="video/mp4"
              />
...
<form onSubmit={submitHandler} >
  ...
  <div className="card-imageship">
<svg width="400" height="200" viewBox="0 0 843 596" fill="none" xmlns="http://www.w3.org/2000/svg">
<g id="A4 - 1">
